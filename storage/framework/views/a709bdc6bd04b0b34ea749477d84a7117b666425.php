		...
		<div class="container">
			<div class="pull-left auto-width-left">
				<ul class="top-menu menu-beta l-inline">
					<li><a href="<?php echo e(route('home-page')); ?>" style="font-size: 120%"><b><i class="fa fa-home" style="font-size: 120%;"></i> Thời trang </b></a></li>
					<li><a style="font-size: 120%; color: magenta"><i class="fa fa-phone" style="font-size: 120%;"></i> 01234.567.890 </a></li>
				</ul>
			</div>
			<div class="pull-right auto-width-right">
				<ul class="top-details menu-beta l-inline">
					<li><a href="<?php echo e(route('home-page')); ?>"><b style="color: blue; font-size: 115%">Đăng ký</b></a></li>
					<li><a href="<?php echo e(route('home-page')); ?>"><b style="color: blue; font-size: 115%">Đăng nhập</b></a></li>
				</ul>
			</div>
